                ...
                <div className='mb-3'>
                    ...
                    <div className="text-center px-3 pb-3 mx-2">
                        <div className="dept-head-info">
                            <div className="row ">
                                <div className="col-lg-3 col-md-3 p-0 col-12">
                                    <img width="100" src="https://dotcom.vip/dcc/ap/upload/107975_01916575242.jpg" alt="" />
                                </div>
                                <div className="col-lg-6 col-md-6 my-auto col-12">
                                    <h6 style={{ color: ' #000', fontSize: '16px', margin: 0 }} className='text-center  fw-bold'>
                                        Mr. Mohammad Zakir Hossain Associate Professor & Head DEPT. OF ACCOUNTING
                                    </h6>
                                </div>
